...
This source code is polished and adapted to work with Tacet. We do not claim any rights to this library. You may use it granted you follow the license.
...
```js
import { before } from '@tacet-mod/patcher'
...
```js
import { after } from '@tacet-mod/patcher'
...
```js
import { before, after, instead } from '@tacet-mod/patcher'
...
```js
import { before, after, instead, HookPriority } from '@tacet-mod/patcher'
