import { Page } from '@tacet-mod/components'
import { Design } from '@tacet-mod/discord/design'
import { nodeUtil } from '@tacet-mod/externals/browserify'
import { getErrorStack } from '@tacet-mod/utils/error'
import { sleep } from '@tacet-mod/utils/promise'
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 32 }}>
            <Page spacing={16}>
                <TextArea
                    ...
                    placeholder="tacet.discord.native.BundleUpdaterManager.reload()"
                    size="md"
                />
                ...
                <Button
                    onPress={async function onPress() {
                        ...
                        try {
                            if (!api) {
                                setResult(
                                    '<Tacet API not available, snippet will be run without it...>',
                                )
                            ...
                            const res = (0, eval)(
                                `var api=${key},{unscoped:tacet}=api;undefined;${code.current}//# sourceURL=Tacet:EvalJS`,
                            )
