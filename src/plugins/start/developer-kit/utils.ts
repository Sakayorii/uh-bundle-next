...
import TacetDeveloperSetting from './definitions/TacetDeveloperSetting'
import TestErrorBoundarySetting from './definitions/TestErrorBoundarySetting'

export function register() {
    api.cleanup(
        registerSettingsItems({
            [Setting.TacetDeveloper]: TacetDeveloperSetting,
        ...
        addSettingsItemToSection('TACET', Setting.TacetDeveloper),
    )
}
